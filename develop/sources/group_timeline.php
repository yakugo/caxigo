...
/* */
$themeData['timeline_group_privacy'] = ucfirst($timeline['group_privacy']);
...
elseif ($_GET['tab2'] == "settings" && $isGroupAdmin)
{
    ...
    $themeData['tab_content'] = \SocialKit\UI::view('timeline/group/settings-tab');
}
else
{
...
$themeData['sidebar_postfilters'] = \SocialKit\UI::view('timeline/group/sidebar-post-filters');
