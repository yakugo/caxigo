...
<form class="content-container" method="post" action="?tab1=edit_page&id=<?php echo $_GET['id'] ?>">
    ...
    <div class="content-wrapper">
        ...
        <div class="input float-left">
            <textarea name="about"><?php echo str_replace('<br>', "\n", $page['about']); ?></textarea>
        ...
        <div class="input float-left">
            <select name="category_id">
                ...
                <optgroup label="<?php echo $sql_fetch_one['name']; ?>">
                    ...
                    <option value="<?php echo $sql_fetch_two['id']; ?>"<?php if ($page['category_id'] == $sql_fetch_two['id']) echo ' selected'; ?>>
                        <?php echo $lang[$sql_fetch_two['name']]; ?>
                    </option>
                    <?php } ?>
                </optgroup>
                <?php } ?>
