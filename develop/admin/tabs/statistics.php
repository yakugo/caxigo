...
// Stories posted
$stories_posted_main_query = "SELECT id FROM " . DB_POSTS . " WHERE active=1";
...
// Comments posted
$comments_posted_main_query = "SELECT id FROM " . DB_COMMENTS . " WHERE active=1";
...
// Posts Liked
$posts_liked_main_query = "SELECT id FROM " . DB_POSTLIKES . " WHERE active=1";
...
// Posts Shared
$posts_shared_main_query = "SELECT id FROM " . DB_POSTSHARES . " WHERE active=1";
...
// Posts Reported
$posts_reported_main_query = "SELECT id FROM " . DB_REPORTS . " WHERE active=1";
